...
model.load_weights('autoencoder_weight_first_two_layer_1024.h5')
...
print('Classification Rate %02.3f' % model.evaluate(X_test, Y_test, show_accuracy=True)[1])

new_model = copy_freeze_model(model, 5)
new_model.save_weights('1024_512_weights_5_layers.h5')
